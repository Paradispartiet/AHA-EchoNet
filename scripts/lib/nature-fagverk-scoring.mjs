...
export function scoreNature(textValue, corpus, policy) {
  ...
  const scores = corpus.entries.map((entry) => {
    ...
    return {
      ...
      eligible,
      eligibility_reason: !domain.eligible ? "missing_nature_domain_anchor" : anchorEligible ? "eligible" : "missing_required_anchor",
