// AHA V2 release-quality guard.
//
// This is a read-path/provider decorator only. The authoritative
// SemanticDocumentV2, AnalysisBundleV2 validation and write-policy contracts
// remain unchanged. The guard improves long academic source coverage and
// distinguishes core analysis readiness from optional enrichment readiness.
(function (global) {
  "use strict";
  ...
  const api = Object.freeze({
    ...
    repairHydratedReadModel,
    wrapInsightPipelineInstance,
    wrapProviderLoader
  });

  global.AHAV2ReleaseQualityGuard = api;
