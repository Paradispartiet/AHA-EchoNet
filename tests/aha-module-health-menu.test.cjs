...
assert.ok(mount.innerHTML.includes('aria-label="Begrepslister: Ready, 12. Lists passed local validation."'), 'badge should expose the current product title, status, count and reason accessibly');
