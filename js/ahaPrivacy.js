...
(function (global) {
  ...
  const STORAGE_DEFINITIONS = [
    ...
    { key: "aha_concept_lists_v1", label: "AHA Begrepslister", kind: "array", isAHA: true, isHistoryGo: false, canClear: true },
    { key: "aha_lists_v1", label: "AHA Samlinger", kind: "array", isAHA: true, isHistoryGo: false, canClear: true },
    { key: "aha_paths_v1", label: "AHA Kunnskapsstier", kind: "array", isAHA: true, isHistoryGo: false, canClear: true },
