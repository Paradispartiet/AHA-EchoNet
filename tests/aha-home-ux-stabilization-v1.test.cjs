...
for (const id of ['aha-local-home-hero','aha-local-home-priority-strip','aha-local-home-highlights','aha-local-home-active-work','aha-local-home-projects','aha-local-home-recent','aha-local-home-module-tiles','aha-local-home-technical-details']) assert.match(index, new RegExp(id));
assert.doesNotMatch(index, /aha-local-home-next-action|aha-local-home-daily-loop/, 'Home should not duplicate the global Daily Loop footer');
