...
const RUNTIME_FILES = ["js/ahaPersonalAiLoopAudit.js", "js/ahaTrainingDashboard.js", "js/ahaChatAnalysisRunContract.js", "js/ahaChatAcademicInsightView.js", "js/ahaChat.js", "js/metaInsightsAgent.js"];
const REQUIRED_KEYS = [
