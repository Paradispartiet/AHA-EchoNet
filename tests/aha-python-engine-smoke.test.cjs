...
function buildContext(seed = {}) {
  ...
  const files = [
    ...
    'js/ahaChatAnalysisPolicy.js', 'js/ahaChatCanonicalAnalysis.js', 'js/ahaChatKnowledgeView.js', 'js/ahaChatInsightPipeline.js', 'js/ahaChatPersonalUi.js', 'js/ahaChat.js',
