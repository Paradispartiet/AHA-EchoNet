...
if (!isRuntimeV2) {
  ...
  assert.deepEqual(approved.legacy_seed.overridden_subject_ids, ['politikk']);
  assert.deepEqual(Object.keys(approved.approved_subjects), ['politikk']);
  ...
  assert.deepEqual(runtimeActive.legacy_seed.overridden_subject_ids, ['politikk']);
  assert.deepEqual(Object.keys(runtimeActive.active_subjects), ['politikk']);
  ...
  assert.equal(runtimeActive.effective_entry_count, 15);
