...
assert.match(hubSource, /aha-local-home-technical-details/);
assert.match(hubSource, /insertAdjacentHTML\("beforebegin", productionCardMarkup\(\)\)/);
assert.match(hubSource, /visible_home_manual_control_ready/);
